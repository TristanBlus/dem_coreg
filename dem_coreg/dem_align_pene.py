...
def getparser():
    ...
    parser.add_argument('-tol', type=float, default=0.02,
                        help='When iterative translation magnitude is below this tolerance (meters), break and write '
                             'out corrected DEM')
    ...
    while True:
        ...
        if n > max_iter or dm < tol:
            ...
            if True:
                ...
                # 冰川区内大坡度区域
                slope = get_filtered_slope(src_dem_clip_ds_align, slope_lim=(0.01, 20))
                ...
                diff_align_filt_nonglac = outlier_filter(diff_align_filt_nonglac, f=2, max_dz=max_dz)
